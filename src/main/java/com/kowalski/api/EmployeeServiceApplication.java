...
import com.kowalski.api.employee.model.Employee;
import com.kowalski.api.employee.repository.EmployeeRepository;
...
public class EmployeeServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.kowalski.api.employee.controller"))
